...
public interface InputListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link InputParser#class_instance}.
	 * @param ctx the parse tree
	 */
	void enterClass_instance(InputParser.Class_instanceContext ctx);
	/**
	 * Exit a parse tree produced by {@link InputParser#class_instance}.
	 * @param ctx the parse tree
	 */
	void exitClass_instance(InputParser.Class_instanceContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link InputParser#name}.
	 * @param ctx the parse tree
	 */
	void enterName(InputParser.NameContext ctx);
	/**
	 * Exit a parse tree produced by {@link InputParser#name}.
	 * @param ctx the parse tree
	 */
	void exitName(InputParser.NameContext ctx);
	/**
	 * Enter a parse tree produced by {@link InputParser#string}.
	 * @param ctx the parse tree
	 */
	void enterString(InputParser.StringContext ctx);
	/**
	 * Exit a parse tree produced by {@link InputParser#string}.
	 * @param ctx the parse tree
	 */
	void exitString(InputParser.StringContext ctx);
	/**
