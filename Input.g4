...
input_expression: (variable_declaration | variable_name) '=' variable_name '.' INPUT_METHOD '(' radix? ')' ';' ;
solitary_input_expression: (variable_declaration | variable_name) '=' new_scanner '.' INPUT_METHOD '(' radix? ')' ';' ;
...
variable_name: special_char name ;

special_char : '_' | '$' | LETTER ;
name : string name* ;
string : (num | LETTER | SYMBOL) string* ;
num : DIGIT num* ;