...
public interface InputVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link InputParser#class_instance}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_instance(InputParser.Class_instanceContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link InputParser#name}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitName(InputParser.NameContext ctx);
	/**
	 * Visit a parse tree produced by {@link InputParser#string}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitString(InputParser.StringContext ctx);
	/**
